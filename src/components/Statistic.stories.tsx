...
export const Default: Story = { args: { title: 'Account Balance', value: 112893, prefix: '$' } }

export const WithTrend: Story = {
  args: { title: 'Active', value: 11.28, precision: 2, prefix: <ArrowUp />, suffix: '%' },
}
...
export const InCards: Story = {
  render: () => (
    <Row gutter={16}>
      <Col>
        <Card><Statistic title="Active Users" value={1242} /></Card>
      </Col>
      <Col>
        <Card><Statistic title="Feedback" value={860} /></Card>
      </Col>
    </Row>
  ),
}
