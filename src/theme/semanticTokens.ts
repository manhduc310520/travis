...
export const semanticFixed: Record<Mode, Tokens> = {
  light: {
    ...
    colorErrorBg: '#FFF2F0', colorErrorBgHover: '#FFF1F0', colorErrorBorder: '#FFCCC7',
    ...
    colorSuccessBg: '#F6FFED', colorSuccessBgHover: '#D9F7BE', colorSuccessBorder: '#B7EB8F',
    ...
    colorWarningBg: '#FFFBE6', colorWarningBgHover: '#FFF1B8', colorWarningBorder: '#FFE58F',
